...
const Heading = () => {
	return (
		<div
			className="mt-24 bg-no-repeat bg-top  h-screen w-9/12 bg-contain m-8 flex items-center flex-col gap-[65px]"
			style={{ backgroundImage: "url(/Vector.svg)" }}
		>
			<h1 className="text-lg sm:text-xl md:text-6xl font-bold text-center center">
